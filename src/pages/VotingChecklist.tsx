...
const VotingChecklist = () => {
  ...
  const checklistItems = [
    {
      id: 1,
      en: "Do you have your Voter ID (EPIC) or another valid ID?",
      hi: "क्या आपके पास अपना वोटर आईडी (EPIC) या अन्य वैध आईडी है?",
      icon: <CreditCard size={48} />
    },
    {
      id: 2,
      en: "Have you checked your name in the Voter List?",
      hi: "क्या आपने वोटर लिस्ट में अपना नाम जाँचा है?",
      icon: <Search size={48} />
    },
    {
      id: 3,
      en: "Do you know where your Polling Booth is?",
      hi: "क्या आपको पता है कि आपका मतदान केंद्र कहाँ है?",
      icon: <MapPin size={48} />
    },
    {
      id: 4,
      en: "Are you ready to press the blue button on the EVM?",
      hi: "क्या आप EVM पर नीला बटन दबाने के लिए तैयार हैं?",
        ...
        {checklistItems.map((item, index) => (
          ...
          >
            ...
            <div className="checkbox-wrapper">
              <input type="checkbox" id={`check-${item.id}`} className="custom-checkbox" />
